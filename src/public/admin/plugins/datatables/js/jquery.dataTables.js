...
(/** @lends <global> */function( $ ) {
	...
	DataTable = function( options )
	{
		 ...
		 *    'display index' if you have hidden data events
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
		 *  @example
	...
	DataTable.defaults = {
		...
		/**
		 * This parameter allows you to readily specify the events in the length drop
		 ...
		 * (i.e. "Showing 1 to 10 of 57 events") DataTables will render large numbers
		...
		"oLanguage": {
			...
			"oPaginate": {
				/**
				 * Information to use when using the 'full_numbers' type of pagination for the
				...
				/**
				 * Information to use for the 'next' pagination button (to take the user to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
				...
				/**
				 * Information to use for the 'previous' pagination button (to take the user to
				 * the previous page).
				 *  @type string
				 *  @default Previous
				 *
			 ...
			 *
			 *  @type string
			 *  @default Showing _START_ to _END_ of _TOTAL_ events
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default Showing 0 to 0 of 0 events
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default (filtered from _MAX_ total events)
			 *
			 *  @dtopt Language
			...
			/**
			 * Information which is displayed when the table is processing a user action
			...
			/**
			 * Information shown inside the table records when the is no information to be
