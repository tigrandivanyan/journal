...
(function (factory) {
    ...
    lang: {
      'en-US': {
        ...
        image: {
          ...
          dropImage: 'Drop image or Information',
        ...
        link: {
          ...
          unlink: 'Unlink',
          edit: 'Edit',
          textToDisplay: 'Information to display',
        ...
        shortcut: {
          ...
          close: 'Close',
          textFormatting: 'Information formatting',
          action: 'Action',
      ...
      return $.Deferred(function (deferred) {
        ...
        $linkDialog.one('shown.bs.modal', function () {
          ...
          $linkUrl.on('input', function () {
            toggleBtn($linkBtn, $linkText.val() && $linkUrl.val());
            // display same link on `Information to display` input
  ...
  var Renderer = function () {
    ...
    /**
     * bootstrap icon button admin_panel
     * @private
   ...
   *            // make icon button by admin_panel function
