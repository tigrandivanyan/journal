...
void 0===b.search?!0:b.search,d=!0===b.hidden;if(b.searchoptions&&!0===b.searchoptions.searchhidden&&c||c&&!d)w=!0,u=b.index||b.name,x=a}});if(!l&&u||!1===d.multipleSearch){var z="eq";0<=x&&q[x].searchoptions&&q[x].searchoptions.sopt?z=q[x].searchoptions.sopt[0]:d.sopt&&d.sopt.length&&(z=d.sopt[0]);l={groupOp:"AND",rules:[{field:u,op:z,data:""}]}}w=!1;d.tmplNames&&d.tmplNames.length&&(w=!0,v=d.tmplLabel,v+="<select class='ui-admin_panel'>",v+="<option value='default'>Default</option>",a.each(d.tmplNames,
...
jqm:d.jqModal,onClose:d.onClose});return!1});a("#"+c+"_reset").bind("click",function(){var b={},h=a("#"+c);f.p.search=!1;f.p.resetsearch=!0;!1===d.multipleSearch?b[d.sField]=b[d.sValue]=b[d.sOper]="":b[d.sFilter]="";h[0].resetFilter();w&&a(".ui-admin_panel",m).val("default");a.extend(f.p.postData,b);g=a(f).triggerHandler("jqGridFilterReset");void 0===g&&(g=!0);g&&a.isFunction(d.onReset)&&(g=d.onReset.call(f));!1!==g&&a(f).trigger("reloadGrid",[{page:1}]);d.closeAfterReset&&a.jgrid.hideModal("#"+a.jgrid.jqID(k.themodal),
