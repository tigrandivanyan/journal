...
@section('content')
   ...
   <script type="text/javascript">
    ...
    <header id="page-header">
        <h1>Информация для студийных операторов</h1>   <!-- page title -->
    </header>
        ...
        <div id="panel-5" class="panel panel-default">  <!--  all content div -->
            ...
            <div class="panel-body">    <!-- panel content -->
                <div class="table-responsive">
                    <form action="{{route('admin-panel.information.notice')}}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('patch') }}
                        <textarea name="content" style="width: 100%;">{{$notice->content}}</textarea>
